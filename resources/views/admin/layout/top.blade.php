                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li>
                                    <a href="#">
                                        <i class="fa fa-users text-aqua"></i> 5
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        ></i>
                                        Very long description here that may not
                                        fit into the page and may cause design
                                        problems
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#">
                                        <i class="fa fa-user text-red"></i> You
...
<!-- 左侧 -->
@includeIf('admin.layout.leftpublic')
