                    ...
                    <div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                <div class="box-footer clearfix">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="text" class="form-control" name="goods_name" id="firstname"  value="{{$goods->goods_name}}"
                                            placeholder="请输入商品名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="text" class="form-control" name="goods_price" id="firstname"  value="{{$goods->goods_price}}"
                                            placeholder="请输入商品价格">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="text" class="form-control" name="num" id="firstname"  value="{{$goods->num}}"
                                            placeholder="请输入商品库存">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="text" class="form-control" name="goods_sn" id="firstname" value="{{$goods->goods_sn}}"
                                            placeholder="请输入商品货号">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="file" name="goods_img" value="{{$goods->goods_img}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="lastname" class="col-sm-2 control-label">商品相册</label>
                                        <div class="col-sm-10">
                                        <input type="file" name="goods_imgs[]" multiple value="{{$goods->goods_imgs}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="cate_id" id="firstname">
                                                ...
                                                <option value="{{$v->cate_id}}" @if($v->cate_id == $goods->cate_id) selected @endif>{{str_repeat('—',$v->level*3)}}{{$v->cate_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="profile">
                                <script id="editor" type="text/plain" style="width:1024px;height:500px;" name="goods_desc">{{$goods->goods_desc}}</script>
                            </div>
